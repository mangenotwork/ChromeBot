	...
	tests := []struct {
	...
	}{
		{
			...
			stmt: &ChromeStmt{
				...
				Args: []Expression{
					&String{
						StartPos: Position{Line: 1, Column: 8},
						Value:    "arg1",
					},
					&String{
						StartPos: Position{Line: 1, Column: 13},
						Value:    "arg2=value",
					},
				},
			},
			expected: "chrome \"arg1\" \"arg2=value\" ",
		},
		{
			name: "ChromeStmt 无参数",
			stmt: &ChromeStmt{
		...
		},
		{
			...
			stmt: &ChromeStmt{
				...
				Args: []Expression{
					...
					&Integer{
						StartPos: Position{Line: 1, Column: 14},
						Value:    8080,
					},
				},
			},
			expected: "chrome \"start\" 8080 ",
		},
		{
			name: "ChromeStmt 带布尔参数",
			stmt: &ChromeStmt{
				StartPos: Position{
					Line:   1,
					Column: 1,
				...
				Args: []Expression{
					...
					&Boolean{
						StartPos: Position{Line: 1, Column: 17},
						Value:    true,
					},
				},
			},
			expected: "chrome \"headless\" true ",
		},
	}
